...
@Component
public class CommitInventoryCommandListener {

    private final ObjectMapper objectMapper;
    private final InventorySettlementService inventorySettlementService;

    public CommitInventoryCommandListener(
    ...
    @RabbitListener(queues = InventoryMessagingConfiguration.COMMIT_REQUEST_QUEUE)
